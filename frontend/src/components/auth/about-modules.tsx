      ...
      <div className="mt-8 grid w-full grid-cols-1 gap-4 sm:grid-cols-2">
        {MODULES.map((m) => (
          ...
          >
            ...
            <h4 className="font-heading text-base font-bold uppercase tracking-[0.12em] text-white">
              {m.title}
            </h4>
            <p className="text-sm leading-relaxed text-white/45">
              {m.description}
            </p>
            <p className="mt-auto font-mono text-[0.7rem] font-medium tracking-[0.1em] text-white/30">
              {m.tag}
            </p>
          </article>
        ))}
        ...
        >
          ...
          <span className="font-mono text-[0.7rem] tracking-[0.1em] text-white/40">
